...
export const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    description: 'Collection of endpoints related to operation. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
  }, // TODO: Find a way to refresh and load the following properties that depend on this property
  {
    ...
    description: 'Endpoints related to operation. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
  },
  {
  ...
  {
    displayName: 'This node is still in beta. Leave an issue here for quick fixes https://github.com/onlypfachi/n8n-nodes-payspace/issues',
    name: 'notice',
    type: 'notice',
    default: '',
  },
